...
[![](https://jaywcjlove.github.io/sb/ico/linux.svg)](https://github.com/Hak-L/linux-command/)
[![](https://jaywcjlove.github.io/sb/ico/weibo.svg)](https://weibo.com/sgl1314)
...
[Github Web版](https://github.com/Hak-L/linux-command) | [Mac/Win/Linux](https://github.com/haloislet/linux-command)


预览搜索：**https://www.sgl666.top/linux**

[![Linux 命令大全](./Linux.gif)](https://github.com/Hak-L/linux-command)

[![Linux 命令大全](./alfred.png)](https://github.com/Hak-L/linux-command)
...
*这里存放Linux 命令大全并不全，你可以通过[linux-command](https://github.com/Hak-L/linux-command/)来搜索，它是把 [command](./command) 目录里面搜集的命令，生成了静态HTML并提供预览以及索引搜索。*
